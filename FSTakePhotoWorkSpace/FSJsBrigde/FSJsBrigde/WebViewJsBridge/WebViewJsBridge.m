...
+ (instancetype)bridgeForWebView:(UIWebView*)webView webViewDelegate:(NSObject<UIWebViewDelegate>*)webViewDelegate UIViewController:(UIViewController*)viewController {
    ...
    return [self bridgeForWebView:webView webViewDelegate:webViewDelegate resourceBundle:nil UIViewController:viewController];
}
...
+ (instancetype)bridgeForWebView:(UIWebView*)webView webViewDelegate:(NSObject<UIWebViewDelegate>*)webViewDelegate resourceBundle:(NSBundle*)bundle UIViewController:(UIViewController*)viewController
{
    ...
    [bridge _platformSpecificSetup:webView webViewDelegate:webViewDelegate resourceBundle:bundle UIViewController:viewController];
    return bridge;
}

#pragma mark - init & dealloc

- (void) _platformSpecificSetup:(UIWebView*)webView webViewDelegate:(id<UIWebViewDelegate>)webViewDelegate resourceBundle:(NSBundle*)bundle UIViewController:(UIViewController*)viewController{
    _webView = webView;
